		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktflowflowchart1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktflowflowchart1-display": {
								"semanticObject": "comsapktflowflowchart1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.flow.flowchart1",
									"url": sap.ui.require.toUrl("com/sap/kt/flow/flowchart1")
								}
							}
						}
					}
